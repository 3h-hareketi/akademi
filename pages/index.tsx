...
const Home: NextPage = () => {
  return (
    <div className="">
      <Head>
        <title>3H Academy</title>
        <meta name="description" content="Generated by create next app" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div className="container flex justify-center mx-auto bg-white px4">
        {/* ---------- Section #1 ----------  */}
        <section>
              ...
              <div className="flex flex-wrap -mx-4">
                <div className="w-full px-4 mb-8 lg:mb-0 lg:w-1/3">
                  <div className="px-6 py-12 text-center bg-white rounded shadow">
                    <span className="inline-block p-2 mb-6 rounded-lg bg-gray-50">
                      <svg
                ...
                <div className="w-full px-4 lg:w-1/3">
                  <div className="px-6 py-12 text-center bg-white rounded shadow">
                    <span className="inline-block p-2 mb-6 rounded bg-gray-50">
                      <svg
                        className="w-10 h-10 text-primary"
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
